...
data = fdata; % Replace your_data with your actual data

% Define the optimal window size
optimal_window_size = 123; % Assuming 701 is the optimal window size (change this to the actual optimal size)
